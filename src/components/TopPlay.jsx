...
const TopPlay = () => {
  ...
  return(
    <div ref={divRef} className='xl:ml-6 ml-0 xl:mb-0 mb-6 flex-1 xl:max-w-[350px] max-w-full flex flex-col'>
      <div className='w-full flex flex-col'>
        <div className='flex flex-row justify-between items-center'>
          <h2 className='text-white font-bold font-2xl'>
            Top Charts
          </h2>
          <Link to="/top-charts">
      ...
      <div className='w-ful flex flex-col'>
        <div className='flex flex-row justify-between items-center'>
          <h2 className='text-white font-vold font-2xl'>
            Top Artists
          </h2>
          <Link to="/top-artists">
            <p className='text-gray-300 text-base cusor-pointer'>see more</p>
        ...
        {topPlays?.map((song, i) => (
          ...
          >
            <Link to={`/artists/${song?.artists[0].adamid}`}>
              ...
              className='rounded-full w-fill object-cover' />
              </Link>         
          </SwiperSlide>
        ))}
        </Swiper>
